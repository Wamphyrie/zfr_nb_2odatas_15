...
sap.ui.define([
		...
		"phoenix/zfr_nb_2odatas_15/model/formatter"
	], function (
		BaseController,
		JSONModel,
		History,
		...
		return BaseController.extend("phoenix.zfr_nb_2odatas_15.controller.Object", {
			...
			_onBindingChange : function () {
				...
				this.addHistoryEntry({
					...
					intent: "#Calling2oDataServicesin1Project-display&/WorkerSet/" + sObjectId
				});
